...
export default function ImpactoAnalise() {
  ...
  async function exportPDF() {
    ...
    try {
      ...
      pdf.save(`Relatorio_Impacto_Endura_${date}.pdf`);
    } catch (e) {
      ...
      <div style={S.hdr}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:12}}>
          ...
          <button onClick={exportPDF} disabled={exporting} style={{
            ...
            cursor: exporting?"not-allowed":"pointer", border:"none",
            background: exporting?"rgba(232,160,32,0.3)":PALETTE.amber,
            color: exporting?PALETTE.amberLight:"#0B1F3A",
            transition:"all .2s", opacity: exporting?0.7:1,
          }}>
